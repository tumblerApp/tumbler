							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="loginName" class="form-control"
										id="inputEmail3" onblur="checkformname()" value="${user.loginName }" readonly="readonly"> <span
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="password" name="password1" class="form-control"
										id="inputPassword3" onblur="checkpwd()" value="${user.password }"><span
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="password" name="password" class="form-control"
										id="inputPassword4" onblur="rcheckpwd()" value="${user.password }"><span
